...
First 5 rows: fixation probabilities of cooperators

Last 5 rows: fixation probabilities of defectors

For each row:

Column 1: value of the game parameter 𝑟 (e.g., r_1 in the LPGG)

Column 2: fixation probability of the corresponding strategy at that parameter value
